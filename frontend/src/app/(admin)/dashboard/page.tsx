  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className={`grid grid-cols-1 ${isInvestor ? '' : 'lg:grid-cols-3'} gap-8`}>
        {/* Main Chart - Hidden for Investor */}
        {!isInvestor && (
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={charts.daily}>
                    ...
                    <YAxis 
                      ...
                      axisLine={false}
                      tickLine={false}
                      tickFormatter={(val) => `Rp ${val >= 1000000 ? (val/1000000).toFixed(1)+'jt' : val.toLocaleString()}`}
                    />
                    <Tooltip 
                      contentStyle={{ 
                 ...
                 <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-3 text-slate-500 text-xs mt-1">
                           ...
                           <span className="flex items-center gap-1"><Clock className="w-3.5 h-3.5" /> {new Date(activity.createdAt).toLocaleDateString()}</span>
                        </div>
                    </div>
                 </div>
