...
const navItems = [
  ...
  { name: 'Riwayat Booking', icon: History, path: '/bookings', roles: ['super_admin', 'admin_villa'] },
  { name: 'Keuangan', icon: Wallet, path: '/finance', roles: ['super_admin', 'admin_villa', 'investor'] },
  ...
  return (
    <>
      ...
      <button 
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 bg-slate-900 border border-slate-800 rounded-lg shadow-lg text-slate-300"
      >
      ...
      {/* Sidebar Content */}
      <aside className={cn(
        "fixed top-0 left-0 bottom-0 z-50 w-72 bg-slate-950 border-r border-slate-800/50 flex flex-col transition-transform duration-300 ease-in-out",
        "lg:translate-x-0",
        ...
        <div className="p-6 border-b border-slate-800/50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-bold leading-none">SV Villa</h1>
        ...
        <div className="p-4 mt-auto border-t border-slate-800/50">
          <div className="bg-slate-900/50 rounded-2xl p-4 flex items-center gap-3 mb-4">
